...
import { milestones } from "@/utils/stats";
      ...
      <div className="container">
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-4">
            <span
              className={`text-[11px] font-semibold tracking-widest uppercase text-[#4F8CFF]`}
            >
              Timeline
            </span>
          </div>
          ...
          <p
            className={`mt-3 text-[16px] max-w-md mx-auto ${isDark ? "text-gray-400" : "text-gray-500"}`}
          >
        ...
        <div ref={ref} className="relative max-w-2xl mx-auto">
          {/* Vertical line */}
          <div
            className={`absolute left-[28px] top-0 bottom-0 w-px ${isDark ? "bg-white/8" : "bg-gray-100"}`}
          />
            ...
            {milestones.map((item, index) => (
              ...
              >
                ...
                <div
                  className={`absolute left-[20px] top-6 w-4 h-4 rounded-full border-2 flex items-center justify-center ${
                    item.isCurrent
                      ...
                      : item.highlight
                        ? isDark
                          ? "bg-[#4F8CFF]/20 border-[#4F8CFF]/60"
                          : "bg-blue-50 border-blue-300"
                        : isDark
                          ? "bg-[#111827] border-white/20"
                ...
                >
                  ...
                  <p
                    className={`text-[14px] leading-relaxed ${isDark ? "text-gray-400" : "text-gray-500"}`}
                  >
                    {item.description}
                  </p>
                </div>
