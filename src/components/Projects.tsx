    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            <h4
              className={`text-[13px] font-semibold uppercase tracking-wider mb-2 ${isDark ? "text-gray-500" : "text-gray-400"}`}
            >
              The Story
            </h4>
            <p
          ...
          <div>
            <h4
              className={`text-[13px] font-semibold uppercase tracking-wider mb-3 ${isDark ? "text-gray-500" : "text-gray-400"}`}
            >
              Key Features
            </h4>
            <ul className="space-y-2">
              {project.features.map((f) => (
                <li
                  key={f}
                  className={`flex items-center gap-2.5 text-[14px] ${isDark ? "text-gray-300" : "text-gray-600"}`}
                >
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            >
              <h4
                className={`text-[12px] font-semibold uppercase tracking-wider mb-2 ${isDark ? "text-gray-500" : "text-gray-400"}`}
              >
                Challenges
              </h4>
              <p
